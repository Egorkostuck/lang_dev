...
const Games = () => {
    ...
    const GAMES = [
        {img: imgSpeakAndCheck, path:'speak-check-it', name:'Speak and check ', description: 'Say the word on the screen and check your spelling'},
        ...
        {img: imgListenAndGuess, path:'listen-it', name:'Guess and listen', description: 'Say the word on the screen and check your spelling'},
        {img: imgSprintGuess, path:'sprint-it', name:'Sprint by guessing', description: 'Say the word on the screen and check your spelling'},
